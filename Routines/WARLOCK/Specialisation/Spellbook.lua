...
Aurora.SpellHandler.PopulateSpellbook({
    spells = {
        ...
        -- 辅助战斗技能
        cataclysm = NewSpell(152108),         -- 大灾变
        wither = NewSpell(348835),            -- 枯萎
        infernal_bolt = NewSpell(348890),     -- 地狱火螺栓
        malevolence = NewSpell(323983),       -- 恶意
        channel_demonfire = NewSpell(116858), -- 引导恶魔之火
        rain_of_fire = NewSpell(5740),        -- 火焰之雨
        shadowburn = NewSpell(17877),         -- 暗影灼烧
        conflagrate = NewSpell(17962),        -- 燃烧
        ruination = NewSpell(391923),         -- 毁灭
        chaos_bolt = NewSpell(116858),        -- 混乱箭（需确认正确ID）
        dimensional_rift = NewSpell(369511),  -- 维度裂隙
        summon_infernal = NewSpell(1122),     -- 召唤地狱火

        -- 冷却技能
        potion = NewSpell(171264),         -- 战斗药水（通用ID，可替换具体药水ID）
    ...
    auras = {
        ...
        wither_dot = NewSpell(348835),                 -- 枯萎dot
